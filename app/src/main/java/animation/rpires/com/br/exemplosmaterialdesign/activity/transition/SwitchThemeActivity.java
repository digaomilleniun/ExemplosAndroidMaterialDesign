...
import animation.rpires.com.br.exemplosmaterialdesign.utilitarios.GUIUtils;
...
public class SwitchThemeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(sharedpreferences.getInt("theme", R.style.SwitchAppTheme));
        ...
        if (cx != 0 && cy != 0) {
            ...
            revealView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                ...
                public void onViewAttachedToWindow(View v) {
                    ...
                    getWindow().setNavigationBarColor(outValue.data);
    ...
    Animator.AnimatorListener revealAnimationListener = new Animator.AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            Intent i = new Intent(SwitchThemeActivity.this, SwitchThemeActivity.class);
